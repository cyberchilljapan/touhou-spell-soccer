...
- 因縁ペアの掛け合いVN (敵対22ペア + ワンツーで発火する同チームコンビ10ペア、1試合1回)
- 88キャラ全員の接触エンカウント一言 (個別の啖呵)
- キャンペーン敗北時の専用VN (7チーム別、再戦導線つき)
- 勝者と敗者の両視点リザルト会話
- 助っ人1枠: 解放チームから1名借りるライト混成 (古巣戦は自動ベンチ)
- フリー対戦の自チームはストーリー撃破で解放 (解放報酬の実ゲート)
...
- GK択のジャンケン化 (コース読み合い) ・rush 択の見返り再設計・連続行動の被守備逓減
- 2周目要素 (対戦順シャッフル / 隠しトーナメント / 全難易度制覇の真ED)
- 助っ人の複数枠化・フル編成UI
